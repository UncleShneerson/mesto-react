...
export default function ImagePopup (props) {
  console.log ()
  return (
    <div className={`popup popup_funct_image ${props.card.name && 'popup_opened' }`}>
      <figure className="gallery">
        ...
        <img className="gallery__photo" src={props.card.link ? props.card.link : clearPixel} alt={props.card.name}/>
